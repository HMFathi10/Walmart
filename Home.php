        ...
        <div>
            ...
            <div>
                <div class="container">
                    <div class="row mt-4">
                        <!--                        <div class="col-md-4">
                                                    <a href="VideoGamesPage.php" style="text-decoration:blink; color: #000000">
                                                        <div class="card"  style="border: none">
                                                            <img src="Images/FoodCategory.jpg" class="card-img-top" alt="...">
                                                            <div class="card-body">
                        ...
                        <form method = "get" style="width: 33%;margin-bottom: 70px;">
                            <div class="col-md-4" style="max-width: 100%">
                                <a href='VideoGamesPage.php?id=1' style="text-decoration:blink; color: #000000" id="1">
                                    <div class="card" style="border: none; height:366px;align-items: center;">
                                        <img src="Images/FoodCategory.jpg" class="card-img-top" alt="..." style="height: 75%;width: 100%;">
                                        <div class="card-body">
                                            <h5 class="card-title" style="text-align: center">Food</h5>
                                        </div>
                                    </div>
                        ...
                        <!--                        <div class="col-md-4">
                                                    <a href="#" style="text-decoration:blink; color: #000000">
                                                        <div class="card" style="border: none">
                                                            <img src="Images/Women'sClothes.jpg" class="card-img-top" style="max-height: 270px;" alt="...">
                                                            <div class="card-body">
                                                                <h5 class="card-title" style="text-align: center">Women's Clothing</h5>
                        ...
                        <form method = "get" style="width: 33%;margin-bottom: 70px;">
                            <div class="col-md-4" style="max-width: 100%">
                                <a href='VideoGamesPage.php?id=2' style="text-decoration:blink; color: #000000" id="2">
                                    <div class="card" style="border: none; height:366px;align-items: center;">
                                        <img src="Images/Women'sClothes.jpg" class="card-img-top" alt="..." style="height: 75%;width: 100%;">
                                        <div class="card-body">
                                            <h5 class="card-title" style="text-align: center">Women's Clothing</h5>
                                        </div>
                                    </div>
                        ...
                        <!--                        <div class="col-md-4">
                                                    <a href="#" style="text-decoration:blink; color: #000000">
                                                        <div class="card" style="border: none">
                                                            <img src="Images/Elec.jpg" class="card-img-top" style="max-height: 270px;" alt="...">
                                                            <div class="card-body">
                                                                <h5 class="card-title" style="text-align: center">Electonics</h5>
                                                                <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                                                <a href="#" class="btn btn-primary">See more</a>
                                                            </div>
                                                        </div>
                        ...
                        <form method = "get" style="width: 33%;margin-bottom: 70px;">
                            <div class="col-md-4" style="max-width: 100%">
                                <a href='VideoGamesPage.php?id=3' style="text-decoration:blink; color: #000000" id="3">
                                    <div class="card" style="border: none; height:366px;align-items: center;">
                                        <img src="Images/Elec.jpg" class="card-img-top" alt="..." style="height: 75%;width: 100%;">
                                        <div class="card-body">
                                            <h5 class="card-title" style="text-align: center">Electronics</h5>
                                        </div>
                                    </div>
                                </a>
                            </div>
                        ...
                        <!--                        <div class="col-md-4">
                                                    <a href="#" style="text-decoration:blink; color: #000000">
                                                        <div class="card" style="border: none">
                                                            <img src="Images/Men'sClothes.png" class="card-img-top" style="max-height: 270px;" alt="...">
                                                            <div class="card-body">
                                                                <h5 class="card-title" style="text-align: center">Men's Clothing</h5>
                                                                <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                                                <a href="#" class="btn btn-primary">See more</a>
                                                            </div>
                                                        </div>
                        ...
                        <form method = "get" style="width: 33%;margin-bottom: 70px;">
                            <div class="col-md-4" style="max-width: 100%">
                                <a href='VideoGamesPage.php?id=4' style="text-decoration:blink; color: #000000" id="4">
                                    <div class="card" style="border: none; height:366px;align-items: center;">
                                        <img src="Images/Men'sClothes.png" class="card-img-top" alt="..." style="height: 75%;width: 100%;">
                                        <div class="card-body">
                                            <h5 class="card-title" style="text-align: center">Men's Clothing</h5>
                                        </div>
                                    </div>
                        ...
                        <!--                        <div class="col-md-4">
                                                    <a href="#" style="text-decoration:blink; color: #000000">
                                                        <div class="card" style="border: none">
                                                            <img src="Images/PS5-Fisica-1.png" class="card-img-top" style="max-height: 270px;" alt="...">
                                                            <div class="card-body">
                                                                <h5 class="card-title" style="text-align: center">Video Games</h5>
                                                            </div>
                                                        </div>
                                                    </a>
                                                </div>-->
                        <form method = "get" style="width: 33%;margin-bottom: 70px;">
                            <div class="col-md-4" style="max-width: 100%">
                                <a href='VideoGamesPage.php?id=5' style="text-decoration:blink; color: #000000" id="5">
                                    <div class="card" style="border: none; height:366px;align-items: center;">
                                        <img src="Images/PS5-Fisica-1.png" class="card-img-top" alt="..." style="height: 75%;width: 100%;">
                                        <div class="card-body">
                                            <h5 class="card-title" style="text-align: center">Video Games</h5>
                                        </div>
                                    </div>
                        ...
                        <!--                        <div class="col-md-4">
                                                    <a href="#" style="text-decoration:blink; color: #000000">
                                                        <div class="card" style="border: none">
                                                            <img src="Images/Furneture.png" class="card-img-top" style="max-height: 270px;min-height: 270px;" alt="...">
                                                            <div class="card-body">
                                                                <h5 class="card-title" style="text-align: center">Furniture</h5>
                                                                <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                                                <a href="#" class="btn btn-primary">See more</a>
                                                            </div>
                                                        </div>
                        ...
                        <form method = "get" style="width: 33%;margin-bottom: 70px;">
                            <div class="col-md-4" style="max-width: 100%">
                                <a href='VideoGamesPage.php?id=6' style="text-decoration:blink; color: #000000" id="6">
                                    <div class="card" style="border: none; height:366px;align-items: center;">
                                        <img src="Images/Furneture.png" class="card-img-top" alt="..." style="height: 75%;width: 100%;">
                                        <div class="card-body">
                                            <h5 class="card-title" style="text-align: center">Furniture</h5>
                                        </div>
                                    </div>
